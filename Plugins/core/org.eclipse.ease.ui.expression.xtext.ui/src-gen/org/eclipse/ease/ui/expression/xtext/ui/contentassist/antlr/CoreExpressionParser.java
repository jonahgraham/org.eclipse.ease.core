		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIterableExpressionAccess().getGroup_3(), "rule__IterableExpression__Group_3__0");
					...
					put(grammarAccess.getIterableExpressionAccess().getOperandAssignment_3_1(), "rule__IterableExpression__OperandAssignment_3_1");
