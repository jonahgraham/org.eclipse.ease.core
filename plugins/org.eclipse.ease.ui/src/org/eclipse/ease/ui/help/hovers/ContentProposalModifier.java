...
public class ContentProposalModifier extends ContentProposalAdapter {
	...
	/*
	 * The lightweight popup used to show content proposals for a text field. If additional information exists for a proposal, then selecting that proposal will
	 * result in the information being displayed in a secondary popup.
	 */
		...
		private final class TargetControlListener implements Listener {
			...
			public void handleEvent(final Event e) {
				...
				if (key == 0) {
					...
					default:
						if ((e.keyCode != SWT.CAPS_LOCK) && (e.keyCode != SWT.NUM_LOCK) && (e.keyCode != SWT.MOD1) && (e.keyCode != SWT.MOD2)
	 ...
	 *
	 * @deprecated As of 3.4, filtering that is sensitive to changes in the control content should be performed by the supplied {@link IContentProposalProvider}
	 *             , such as that performed by {@link SimpleContentProposalProvider}
	 */
	@Deprecated
	public static final int FILTER_CUMULATIVE = 3;

	/*
	 * Set to <code>true</code> to use a Table with SWT.VIRTUAL. This is a workaround for https://bugs.eclipse.org/bugs/show_bug.cgi?id=98585#c40 The
	 * corresponding SWT bug is https://bugs.eclipse.org/bugs/show_bug.cgi?id=90321
	 */
	 ...
	 */
	public ContentProposalModifier(final Control control, final IControlContentAdapter controlContentAdapter, final IContentProposalProvider proposalProvider,
			final KeyStroke keyStroke, final char[] autoActivationCharacters) {
