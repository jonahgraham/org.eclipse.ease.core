...
/**
 * An internal class that gives access to internal methods of {@link AbstractInformationControlManager} and subclasses.
 *
 * @since 3.4
 */
public abstract class InternalAccessor {
	...
	/**
	 * Replaces this manager's information control as defined by the information control replacer. <strong>Must only be called when the information control is
